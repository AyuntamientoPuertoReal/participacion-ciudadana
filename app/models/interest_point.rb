class InterestPoint < ApplicationRecord
  ...
  validates :name, :latitude, :longitude, :description, presence: { message: I18n.t("error_messages.blank_field")}
  ...
  has_one_attached :point_image
  validates :point_image, attached: true
