...
admin = Staff.find_by(username: "administrador")
if admin.role.blank?
...
IncidenceType.find_or_create_by(code: "PAR", name: "Parques y Jardines", description: "Incidencias sobre Parques y Jardines", order: 1)
IncidenceType.find_or_create_by(code: "INF", name: "Infraestructura", description: "Incidencias sobre Infraestructura", order: 2)
IncidenceType.find_or_create_by(code: "LIM", name: "Limpieza", description: "Incidencias sobre Limpieza", order: 3)
IncidenceType.find_or_create_by(code: "ILU", name: "Iluminación", description: "Incidencias sobre Iluminación", order: 4)
IncidenceType.find_or_create_by(code: "RES", name: "Recogida de Residuos", description: "Incidencias sobre la Recogida de Residuos", order: 5)
IncidenceType.find_or_create_by(code: "AMB", name: "Medio Ambiente", description: "Incidencias sobre Medioambiente", order: 6)
IncidenceType.find_or_create_by(code: "SAN", name: "Saneamiento", description: "Incidencias sobre Saneamiento", order: 7)
IncidenceType.find_or_create_by(code: "GEN", name: "General", description: "Incidencias Generales", order: 8)
puts "✔"

# Puntos de interés
print "Creando los puntos de interés... "
InterestPoint.find_or_create_by(name: "Ayuntamiento - Casa Consistorial", latitude: "36.52866345", longitude: "-6.143663",
...
InterestPoint.find_or_create_by(name: "IMPRO", latitude: "36.526096", longitude: "-6.178938",
                                image_url: "http://www.puertorealweb.es/spip2/IMG/arton18921.jpg",
                                description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas venenatis, massa vel ornare viverra, metus ex laoreet purus, vel maximus nibh est quis risus. Praesent euismod ultricies congue. Duis ut consequat nisi. Quisque vehicula dapibus nibh, vel rhoncus enim hendrerit a. Ut dictum, lacus ac eleifend bibendum, turpis diam pharetra libero, non eleifend arcu felis quis lectus. Aliquam erat volutpat. Sed nec efficitur nisl. Donec in ligula est. Vestibulum malesuada nec tortor in sollicitudin. Phasellus ultrices consequat ex, consectetur finibus nunc consequat vel. Donec blandit et sem et aliquam. Quisque ac turpis ut arcu placerat venenatis.")
InterestPoint.find_or_create_by(name: "OMIC", latitude: "36.527724", longitude: "-6.19251",
                                image_url: "https://www.puertorealhoy.es/wp-content/uploads/2014/05/2014_pr_centro_administrativo_mpal.jpg",
                                description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas venenatis, massa vel ornare viverra, metus ex laoreet purus, vel maximus nibh est quis risus. Praesent euismod ultricies congue. Duis ut consequat nisi. Quisque vehicula dapibus nibh, vel rhoncus enim hendrerit a. Ut dictum, lacus ac eleifend bibendum, turpis diam pharetra libero, non eleifend arcu felis quis lectus. Aliquam erat volutpat. Sed nec efficitur nisl. Donec in ligula est. Vestibulum malesuada nec tortor in sollicitudin. Phasellus ultrices consequat ex, consectetur finibus nunc consequat vel. Donec blandit et sem et aliquam. Quisque ac turpis ut arcu placerat venenatis.")
InterestPoint.find_or_create_by(name: "Ayuntamiento - Centro Administrativo Municipal", latitude: "36.52579575", longitude: "-6.19104836",
                                image_url: "https://www.estudiosegui.com/wp-content/uploads/2017/02/01_Ayto-Puerto-Real-min.jpg",
                                description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas venenatis, massa vel ornare viverra, metus ex laoreet purus, vel maximus nibh est quis risus. Praesent euismod ultricies congue. Duis ut consequat nisi. Quisque vehicula dapibus nibh, vel rhoncus enim hendrerit a. Ut dictum, lacus ac eleifend bibendum, turpis diam pharetra libero, non eleifend arcu felis quis lectus. Aliquam erat volutpat. Sed nec efficitur nisl. Donec in ligula est. Vestibulum malesuada nec tortor in sollicitudin. Phasellus ultrices consequat ex, consectetur finibus nunc consequat vel. Donec blandit et sem et aliquam. Quisque ac turpis ut arcu placerat venenatis.")
InterestPoint.find_or_create_by(name: "Centro Cívico Barrio de Jarana", latitude: "36.503815", longitude: "-6.143663",
                                image_url: "http://www.puertorealweb.es/spip2/IMG/arton2273.jpg",
                                description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas venenatis, massa vel ornare viverra, metus ex laoreet purus, vel maximus nibh est quis risus. Praesent euismod ultricies congue. Duis ut consequat nisi. Quisque vehicula dapibus nibh, vel rhoncus enim hendrerit a. Ut dictum, lacus ac eleifend bibendum, turpis diam pharetra libero, non eleifend arcu felis quis lectus. Aliquam erat volutpat. Sed nec efficitur nisl. Donec in ligula est. Vestibulum malesuada nec tortor in sollicitudin. Phasellus ultrices consequat ex, consectetur finibus nunc consequat vel. Donec blandit et sem et aliquam. Quisque ac turpis ut arcu placerat venenatis.")
InterestPoint.find_or_create_by(name: "Centro Cívico Ciudad Abierta", latitude: "36.526219", longitude: "-6.180167",
                                image_url: "https://www.puertorealhoy.es/wp-content/uploads/2014/08/20140819_local_centro_civico_cj.jpg",
                                description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas venenatis, massa vel ornare viverra, metus ex laoreet purus, vel maximus nibh est quis risus. Praesent euismod ultricies congue. Duis ut consequat nisi. Quisque vehicula dapibus nibh, vel rhoncus enim hendrerit a. Ut dictum, lacus ac eleifend bibendum, turpis diam pharetra libero, non eleifend arcu felis quis lectus. Aliquam erat volutpat. Sed nec efficitur nisl. Donec in ligula est. Vestibulum malesuada nec tortor in sollicitudin. Phasellus ultrices consequat ex, consectetur finibus nunc consequat vel. Donec blandit et sem et aliquam. Quisque ac turpis ut arcu placerat venenatis.")
InterestPoint.find_or_create_by(name: "Centro Cívico Rio San Pedro", latitude: "36.523887", longitude: "-6.223658",
                                ...
                                description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas venenatis, massa vel ornare viverra, metus ex laoreet purus, vel maximus nibh est quis risus. Praesent euismod ultricies congue. Duis ut consequat nisi. Quisque vehicula dapibus nibh, vel rhoncus enim hendrerit a. Ut dictum, lacus ac eleifend bibendum, turpis diam pharetra libero, non eleifend arcu felis quis lectus. Aliquam erat volutpat. Sed nec efficitur nisl. Donec in ligula est. Vestibulum malesuada nec tortor in sollicitudin. Phasellus ultrices consequat ex, consectetur finibus nunc consequat vel. Donec blandit et sem et aliquam. Quisque ac turpis ut arcu placerat venenatis.")
InterestPoint.find_or_create_by(name: "Sala de Barrio 512", latitude: "36.53249", longitude: "-6.197565",
                                image_url: "https://s3.static-clubeo.com/uploads/sdcandray/grounds/sala-de-barrio-512__oekely.jpg",
                                description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas venenatis, massa vel ornare viverra, metus ex laoreet purus, vel maximus nibh est quis risus. Praesent euismod ultricies congue. Duis ut consequat nisi. Quisque vehicula dapibus nibh, vel rhoncus enim hendrerit a. Ut dictum, lacus ac eleifend bibendum, turpis diam pharetra libero, non eleifend arcu felis quis lectus. Aliquam erat volutpat. Sed nec efficitur nisl. Donec in ligula est. Vestibulum malesuada nec tortor in sollicitudin. Phasellus ultrices consequat ex, consectetur finibus nunc consequat vel. Donec blandit et sem et aliquam. Quisque ac turpis ut arcu placerat venenatis.")
InterestPoint.find_or_create_by(name: "Sala Barrio Río San Pedro", latitude: "36.523829", longitude: "-6.232195",
                                image_url: "https://s2.static-clubeo.com/uploads/sdcandray/grounds/sala-de-barrio-rio-san-pedro__oekete.jpg",
                                description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas venenatis, massa vel ornare viverra, metus ex laoreet purus, vel maximus nibh est quis risus. Praesent euismod ultricies congue. Duis ut consequat nisi. Quisque vehicula dapibus nibh, vel rhoncus enim hendrerit a. Ut dictum, lacus ac eleifend bibendum, turpis diam pharetra libero, non eleifend arcu felis quis lectus. Aliquam erat volutpat. Sed nec efficitur nisl. Donec in ligula est. Vestibulum malesuada nec tortor in sollicitudin. Phasellus ultrices consequat ex, consectetur finibus nunc consequat vel. Donec blandit et sem et aliquam. Quisque ac turpis ut arcu placerat venenatis.")
InterestPoint.find_or_create_by(name: "Centro Cultural Iglesia de San José", latitude: "36.528821", longitude: "-6.190772",
                                image_url: "https://andaluciarustica.com/wp-content/uploads/2017/05/puerto-real-iglesia-de-san-jose.jpg",
                                description: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas venenatis, massa vel ornare viverra, metus ex laoreet purus, vel maximus nibh est quis risus. Praesent euismod ultricies congue. Duis ut consequat nisi. Quisque vehicula dapibus nibh, vel rhoncus enim hendrerit a. Ut dictum, lacus ac eleifend bibendum, turpis diam pharetra libero, non eleifend arcu felis quis lectus. Aliquam erat volutpat. Sed nec efficitur nisl. Donec in ligula est. Vestibulum malesuada nec tortor in sollicitudin. Phasellus ultrices consequat ex, consectetur finibus nunc consequat vel. Donec blandit et sem et aliquam. Quisque ac turpis ut arcu placerat venenatis.")
InterestPoint.find_or_create_by(name: "Centro de Servicios Sociales 512", latitude: "36.53136", longitude: "-6.19696",
...
News.find_or_create_by(title: "Jornadas gratuitas", description: "Nuevas fuentes de financiación para entidades sin ánimo de lucro",
